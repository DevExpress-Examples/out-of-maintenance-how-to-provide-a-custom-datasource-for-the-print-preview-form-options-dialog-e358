...
'			Me.customGridView1.GetCustomGridPreview += New System.EventHandler(Of CustomPrintPreview.Grid.GetGridPreviewEventArgs)(Me.OnCustomersViewGetCustomGridPreview);
			' 
			' colID
			' 
...
'			Me.simpleButton1.Click += New System.EventHandler(Me.OnButtonPrintClick);
			' 
			' MainForm
			' 
