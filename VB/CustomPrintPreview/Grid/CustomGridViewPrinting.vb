...
Namespace CustomPrintPreview.Grid
    Partial Public Class CustomGridViewPrinting
        ...
        Public ReadOnly Property UserControlSize() As Size
            Get
                Return ScaleUtils.GetScaleSize(New Size(560, 345))
            End Get
        End Property
        ...
        Private Sub OnCheckBoxCheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkEdit2.CheckStateChanged, checkEdit1.CheckStateChanged, CheckBoxSelectedRows.CheckStateChanged, checkEdit4.CheckedChanged, checkEdit3.CheckStateChanged
            InvalidateImage(DirectCast(sender, CheckEdit))
        End Sub
        ...
        Protected Overridable Sub ApplyOptions(ByVal doSetOptions As Boolean)
            If LockApply <> 0 Then
                Return
            End If
            For i As Integer = 0 To PrintFlags.Length - 1
                ...
                If chb IsNot Nothing Then
                    SetOptions.SetOptionValueByString(PrintFlags(i),If(doSetOptions, EditingView.OptionsPrint, CurrentView.OptionsPrint), chb.Checked)
                End If
            Next i
        ...
        Private Sub OnCheckBoxHorzLinesCheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles CheckBoxHorzLines.CheckStateChanged
            CurrentView.OptionsView.ShowHorizontalLines= If(CheckBoxHorzLines.Checked, DefaultBoolean.True, DefaultBoolean.False)
        ...
        Private Sub OnCheckBoxVertLinesCheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles CheckBoxVertLines.CheckStateChanged
            CurrentView.OptionsView.ShowHorizontalLines = If(CheckBoxVertLines.Checked, DefaultBoolean.True, DefaultBoolean.False)
        ...
        Private Sub InitViewStyles()
            ...
            Try
                ...
                CurrentView.OptionsView.EnableAppearanceEvenRow = If(CheckBoxDefaultStyles.Checked, CheckBoxEvenRow.Checked, EditingView.OptionsView.EnableAppearanceEvenRow)
                CurrentView.OptionsView.EnableAppearanceOddRow = If(CheckBoxDefaultStyles.Checked, CheckBoxOddRow.Checked, EditingView.OptionsView.EnableAppearanceOddRow)
...
#Region "IPrintDesigner Members"
        ...
        Private Sub IPrintDesigner_HideCaption() Implements IPrintDesigner.HideCaption
